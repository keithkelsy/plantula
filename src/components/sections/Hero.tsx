...
function BotanicalTopRight() {
  return (
    <svg
      ...
      className="absolute -top-8 -right-8 w-[220px] opacity-[0.05] pointer-events-none select-none"
      aria-hidden="true"
    >
      {/* Main stem */}
...
function BotanicalBottomLeft() {
  return (
    <svg
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className="absolute -bottom-10 -left-6 w-[180px] opacity-[0.05] pointer-events-none select-none rotate-[15deg]"
      aria-hidden="true"
    >
      {/* Main stem curved */}
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-[900px] mx-auto">
        ...
        >
          ...
          <em className="text-green-light italic">respiran vida</em>
        </motion.h1>
        ...
        >
          Transformamos entornos a través del diseño botánico, el paisajismo
        ...
        <motion.div {...fadeUp(1.1)} className="mt-10 flex flex-wrap items-center justify-center gap-3">
          <Button as="a" href="#contacto" variant="primary" dark>
            Agenda tu consulta
          </Button>
          <Button as="a" href="#proyectos" variant="outline" dark>
            Ver proyectos
          </Button>
        </motion.div>
      </div>
